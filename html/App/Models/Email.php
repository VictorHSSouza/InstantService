...
class Email extends PHPMailer{
    private $link = "localhost:8080";
    private $link_Privacidade = "";
    private $link_Servico = "";
    ...
    public function __construct() {
        $this->link_Privacidade = $this->link."/privacidade";
        $this->link_Servico = $this->link."/servico";
    }  
    ...
    public function email_cad_pedido() {
        //CLIENTE
        $this->assunto = "Confirmação de Pedido - InstantService";
        ...
        $this->corpo_html = '
            ...
            <head>
                <meta charset="UTF-8">
                <meta name="viewport" content="width=device-width, initial-scale=1.0">
                <title>Confirmação de Pedido - InstantService</title>
                <style>
                    body {
                        font-family: Arial, sans-serif;
                        background-color: #f4f4f4;
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        ...
                        <p>Olá ' . $this->dados['nome'] . ',</p>
                        <p>Obrigado por utilizar a <strong>InstantService</strong>! Seu pedido foi recebido com sucesso. Aqui estão os detalhes:</p>
                        <p><strong>Serviço Solicitado:</strong> ' . $this->dados['descricao'] . '</p>
                        <p><strong>Data do Pedido:</strong> ' . date('d/m/Y  h:i') . '</p>
                        <p><strong>Prazo Estimado de Conclusão:</strong> ' . date('d/m/Y  h:i', strtotime('+1 day')) . '</p>
                        <p>Nossa equipe está trabalhando para garantir que o serviço seja realizado com a máxima qualidade. O profissional designado entrará em contato com você em breve para discutir os próximos passos.</p>
                        <p>Você pode acompanhar o status do seu pedido e se comunicar diretamente com o profissional através do nosso portal:</p>
                        <div class="button">
                            <a href="'. $this->link .'/" target="_blank">Acompanhar Pedido</a>
                        </div>
                        <p>Se tiver qualquer dúvida ou precisar de assistência, não hesite em entrar em contato com nossa equipe de suporte.</p>
                        <p>Atenciosamente,</p>
                        <p>Equipe InstantService</p>
                    </div>
                    <div class="footer">
                        <p>&copy; 2024 InstantService. Todos os direitos reservados.</p>
                        <p><a href="'. $this->link_Privacidade .'">Política de Privacidade</a> | <a href="'. $this->link_Servico .'">Termos de Serviço</a></p>
                    </div>
                </div>
            </body>
            </html>
        ...
        $this->corpo_semhtml = '
            ...
            Obrigado por utilizar a InstantService! Seu pedido foi recebido com sucesso. Aqui estão os detalhes:

            Serviço Solicitado: ' . $this->dados['descricao'] . '
            Data do Pedido: ' . date('d/m/Y  h:i') . '
            Prazo de Conclusão: ' . date('d/m/Y  h:i', strtotime('+1 day')) . '

            Nossa equipe está trabalhando para garantir que o serviço seja realizado com a máxima qualidade. O profissional designado entrará em contato com você em breve para discutir os próximos passos.

            Você pode acompanhar o status do seu pedido e se comunicar diretamente com o profissional através do nosso portal:

            '. $this->link .'/

            Se tiver qualquer dúvida ou precisar de assistência, não hesite em entrar em contato com nossa equipe de suporte.
            ...
            Política de Privacidade: '. $this->link_Privacidade .'
            Termos de Serviço: '. $this->link_Servico .'
        ';
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div class="button">
                                <a href="'. $this->link .'/profissional" target="_blank">Ver Pedido</a>
                            </div>
    ...
    public function email_cad_usera()  {
        $this->assunto = "Conta criada - InstantService";
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <div class="button">
                                <a href="'. $this->link .'/" target="_blank">Acessar Meu Painel</a>
                            </div>
                            <p>Se precisar de ajuda, nossa equipe de suporte está sempre à disposição. Basta responder a este e-mail ou visitar nossa seção de suporte.</p>
                            <p>Atenciosamente,</p>
                            <p>Equipe InstantService</p>
